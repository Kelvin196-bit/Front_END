export default function PromoCard({ img, text, promo, onClick }) {
  return (
    <div className="w-[80vw] md:w-[30vw] lg:w-[22vw] bg-light-blue flex rounded-md shadow-lg shadow-slate-300/50">
      <div className="py-5 px-5">
        <p className="text-center text-lg w-20 font-medium rounded-full bg-light-yellow">
          {`${promo}% OFF`}
        </p>
        ...
        <button
          onClick={onClick}
          className="p-1 w-28 rounded-md font-medium text-primary bg-light-gray-3 hover:scale-105 duration-200"
        >
          Comprar
        </button>
      </div>
